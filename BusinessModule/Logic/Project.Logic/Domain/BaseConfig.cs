...
namespace Project.Logic.Domain
{
    ...
    public partial class BaseConfigEntities : Formula.FormulaDbContext
    {
        ...
        public IDbSet<S_CAD_FormURL> S_CAD_FormURL { get; set; } // S_CAD_FormURL
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Configurations.Add(new S_CAD_FormURLConfiguration());
	...
	/// <summary></summary>	
	[Description("")]
    public partial class S_CAD_FormURL : Formula.BaseModel
    {
		/// <summary></summary>	
		[Description("")]
        public string ID { get; set; } // ID (Primary key)
		/// <summary></summary>	
		[Description("")]
        public string ProjectMode { get; set; } // ProjectMode
		/// <summary></summary>	
		[Description("")]
        public string ProjectModeName { get; set; } // ProjectModeName
		/// <summary></summary>	
		[Description("")]
    ...
    public partial class S_T_DBSDefine : Formula.BaseModel
    {
		...
		/// <summary></summary>	
		[Description("")]
        public string CreateEngineering { get; set; } // CreateEngineering
    ...
    // S_CAD_FormURL
    internal partial class S_CAD_FormURLConfiguration : EntityTypeConfiguration<S_CAD_FormURL>
    {
        public S_CAD_FormURLConfiguration()
        {
			ToTable("S_CAD_FORMURL");
            HasKey(x => x.ID);

            Property(x => x.ID).HasColumnName("ID").IsRequired().HasMaxLength(50);
            Property(x => x.ProjectMode).HasColumnName("PROJECTMODE").IsOptional().HasMaxLength(500);
            Property(x => x.ProjectModeName).HasColumnName("PROJECTMODENAME").IsOptional().HasMaxLength(500);
            Property(x => x.Type).HasColumnName("TYPE").IsRequired().HasMaxLength(500);
            Property(x => x.TypeName).HasColumnName("TYPENAME").IsRequired().HasMaxLength(500);
            Property(x => x.HttpUrl).HasColumnName("HTTPURL").IsOptional().HasMaxLength(500);
            Property(x => x.HttpUrlInner).HasColumnName("HTTPURLINNER").IsOptional().HasMaxLength(500);
    ...
    internal partial class S_T_DBSDefineConfiguration : EntityTypeConfiguration<S_T_DBSDefine>
    {
        public S_T_DBSDefineConfiguration()
        {
            ...
            Property(x => x.CreateEngineering).HasColumnName("CREATEENGINEERING").IsOptional().HasMaxLength(50);
