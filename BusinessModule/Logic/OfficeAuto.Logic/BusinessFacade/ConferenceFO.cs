...
namespace OfficeAuto.Logic.BusinessFacade
{
    public class ConferenceFO
    {
        ...
        public static string ConferenceUnOccupy
        {
            get
            {
                return @"<img src=""/OfficeAuto/CusStyle/images_conference/add.png"" width=""24"" height=""24"" align=""absmiddle"" onclick=""LinkToThis('{0}','{1}','{2}');""/>";
            }
        }
        ...
        public static string ConferenceOccupy
        {
            get
            {
                return @"<img src=""/OfficeAuto/CusStyle/images_conference/date.png"" title='已被""{0}""会议占用' width=""24"" height=""24"" align=""absmiddle"" onclick=""LinkToView('{1}');""/>";
            }
        }
        ...
        {
            SQLHelper OfficeAutoDb = SQLHelper.CreateSqlHelper(ConnEnum.OfficeAuto);
            #region SQL String
...
";
            ...
            DataTable tbRooms = OfficeAutoDb.ExecuteDataTable("select Id,ROOMNAME from S_M_ConferenceRoom");
