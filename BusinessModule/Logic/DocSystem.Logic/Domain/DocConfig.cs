...
//     Connection String:      "Data Source=.;Initial Catalog=EPM_Infrastructure;User ID=sa;PWD=123.zxc;"
...
namespace DocSystem.Logic.Domain
{
    ...
    {
        public IDbSet<S_DOC_AtlasConfigDetail> S_DOC_AtlasConfigDetail { get; set; } // S_DOC_AtlasConfigDetail
        ...
        public IDbSet<S_DOC_ReorganizeConfig_FileFormRelation> S_DOC_ReorganizeConfig_FileFormRelation { get; set; } // S_DOC_ReorganizeConfig_FileFormRelation
        public IDbSet<S_DOC_ReorganizeConfig_NodeFormRelation> S_DOC_ReorganizeConfig_NodeFormRelation { get; set; } // S_DOC_ReorganizeConfig_NodeFormRelation
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Configurations.Add(new S_DOC_AtlasConfigDetailConfiguration());
            ...
            modelBuilder.Configurations.Add(new S_DOC_ReorganizeConfig_FileFormRelationConfiguration());
            modelBuilder.Configurations.Add(new S_DOC_ReorganizeConfig_NodeFormRelationConfiguration());
	...
	/// <summary></summary>	
	[Description("")]
    public partial class S_DOC_AtlasConfigDetail : Formula.BaseModel
    {
		/// <summary></summary>	
		[Description("")]
        ...
        // Foreign keys
		[JsonIgnore]
        public virtual S_DOC_File S_DOC_File { get; set; } //  FileID - FK_S_DOC_AtlasConfigDetail_S_DOC_File
    }
    ...
    public partial class S_DOC_File : Formula.BaseModel
    {
		...
		/// <summary></summary>	
		[Description("")]
        public string IsPhysical { get; set; } // IsPhysical
		/// <summary></summary>	
		[Description("")]
        public string IsElectronic { get; set; } // IsElectronic

        // Reverse navigation
		[JsonIgnore]
        public virtual ICollection<S_DOC_AtlasConfigDetail> S_DOC_AtlasConfigDetail { get { onS_DOC_AtlasConfigDetailGetting(); return _S_DOC_AtlasConfigDetail;} }
		private ICollection<S_DOC_AtlasConfigDetail> _S_DOC_AtlasConfigDetail;
		partial void onS_DOC_AtlasConfigDetailGetting();
        ...
        public S_DOC_File()
        {
            _S_DOC_AtlasConfigDetail = new List<S_DOC_AtlasConfigDetail>();
    ...
    public partial class S_DOC_FileAttr : Formula.BaseModel
    {
		...
		/// <summary></summary>	
		[Description("")]
        public string SelectorKey { get; set; } // SelectorKey
		/// <summary></summary>	
		[Description("")]
        public string ReturnParams { get; set; } // ReturnParams
    ...
    public partial class S_DOC_Node : Formula.BaseModel
    {
		...
		/// <summary></summary>	
		[Description("")]
        public string IsPhysicalBox { get; set; } // IsPhysicalBox
		/// <summary></summary>	
		[Description("")]
        public string IsElectronicBox { get; set; } // IsElectronicBox
		/// <summary></summary>	
		[Description("")]
        public string CanDownload { get; set; } // CanDownload
		/// <summary></summary>	
        ...
        // Foreign keys
		[JsonIgnore]
        public virtual S_DOC_Space S_DOC_Space { get; set; } //  SpaceID - FK_S_DOC_Node_S_DOC_Space
    ...
    public partial class S_DOC_NodeStrcut : Formula.BaseModel
    {
        ...
        // Foreign keys
		[JsonIgnore]
        public virtual S_DOC_Space S_DOC_Space { get; set; } //  SpaceID - FK_S_DOC_NodeStrcut_S_DOC_Space
    }
    ...
    public partial class S_DOC_ReorganizeConfig : Formula.BaseModel
    {
		...
		/// <summary></summary>	
		[Description("")]
        public string PhysicalType { get; set; } // PhysicalType
		/// <summary></summary>	
		[Description("")]
        public string PhysicalButtons { get; set; } // PhysicalButtons
		/// <summary></summary>	
		[Description("")]
        public string PhysicalMainFormCode { get; set; } // PhysicalMainFormCode
		/// <summary></summary>	
		[Description("")]
        public string PhysicalMainListCode { get; set; } // PhysicalMainListCode
		/// <summary></summary>	
		[Description("")]
        public string PhysicalVolumnListCode { get; set; } // PhysicalVolumnListCode
		/// <summary></summary>	
		[Description("")]
        public string ElectronicMainFormCode { get; set; } // ElectronicMainFormCode

        // Reverse navigation
		[JsonIgnore]
        public virtual ICollection<S_DOC_ReorganizeConfig_FileFormRelation> S_DOC_ReorganizeConfig_FileFormRelation { get { onS_DOC_ReorganizeConfig_FileFormRelationGetting(); return _S_DOC_ReorganizeConfig_FileFormRelation;} }
		private ICollection<S_DOC_ReorganizeConfig_FileFormRelation> _S_DOC_ReorganizeConfig_FileFormRelation;
		partial void onS_DOC_ReorganizeConfig_FileFormRelationGetting();

		[JsonIgnore]
        public virtual ICollection<S_DOC_ReorganizeConfig_NodeFormRelation> S_DOC_ReorganizeConfig_NodeFormRelation { get { onS_DOC_ReorganizeConfig_NodeFormRelationGetting(); return _S_DOC_ReorganizeConfig_NodeFormRelation;} }
		private ICollection<S_DOC_ReorganizeConfig_NodeFormRelation> _S_DOC_ReorganizeConfig_NodeFormRelation;
		partial void onS_DOC_ReorganizeConfig_NodeFormRelationGetting();
        ...
        public S_DOC_ReorganizeConfig()
        {
            _S_DOC_ReorganizeConfig_FileFormRelation = new List<S_DOC_ReorganizeConfig_FileFormRelation>();
            _S_DOC_ReorganizeConfig_NodeFormRelation = new List<S_DOC_ReorganizeConfig_NodeFormRelation>();
        }
    }

	/// <summary></summary>	
	[Description("")]
    public partial class S_DOC_ReorganizeConfig_FileFormRelation : Formula.BaseModel
    {
		/// <summary></summary>	
		[Description("")]
        public string ID { get; set; } // ID (Primary key)
        ...
        // Foreign keys
		[JsonIgnore]
        public virtual S_DOC_ReorganizeConfig S_DOC_ReorganizeConfig { get; set; } //  ReorganizeConfigID - FK_S_DOC_ReorganizeConfig_FileFormRelation_S_DOC_ReorganizeConfig
    }

	/// <summary></summary>	
	[Description("")]
    public partial class S_DOC_ReorganizeConfig_NodeFormRelation : Formula.BaseModel
    {
		/// <summary></summary>	
		[Description("")]
        public string ID { get; set; } // ID (Primary key)
        ...
        // Foreign keys
		[JsonIgnore]
        public virtual S_DOC_ReorganizeConfig S_DOC_ReorganizeConfig { get; set; } //  ReorganizeConfigID - FK_S_DOC_ReorganizeConfig_NodeFormRelation_S_DOC_ReorganizeConfig
    }
    ...
    // S_DOC_AtlasConfigDetail
    internal partial class S_DOC_AtlasConfigDetailConfiguration : EntityTypeConfiguration<S_DOC_AtlasConfigDetail>
    {
        public S_DOC_AtlasConfigDetailConfiguration()
        {
            ToTable("S_DOC_ATLASCONFIGDETAIL");
            HasKey(x => x.ID);
            ...
            // Foreign keys
            HasRequired(a => a.S_DOC_File).WithMany(b => b.S_DOC_AtlasConfigDetail).HasForeignKey(c => c.FileID); // FK_S_DOC_AtlasConfigDetail_S_DOC_File
        }
    }
    ...
    internal partial class S_DOC_FileConfiguration : EntityTypeConfiguration<S_DOC_File>
    {
        public S_DOC_FileConfiguration()
        {
            ...
            Property(x => x.FileCategory).HasColumnName("FILECATEGORY").IsOptional().HasMaxLength(50);
            Property(x => x.IsPhysical).HasColumnName("ISPHYSICAL").IsOptional().HasMaxLength(50);
            Property(x => x.IsElectronic).HasColumnName("ISELECTRONIC").IsOptional().HasMaxLength(50);
    ...
    internal partial class S_DOC_FileAttrConfiguration : EntityTypeConfiguration<S_DOC_FileAttr>
    {
        public S_DOC_FileAttrConfiguration()
        {
            ...
            Property(x => x.SelectorKey).HasColumnName("SELECTORKEY").IsOptional().HasMaxLength(50);
            Property(x => x.ReturnParams).HasColumnName("RETURNPARAMS").IsOptional().HasMaxLength(2000);
    ...
    internal partial class S_DOC_NodeConfiguration : EntityTypeConfiguration<S_DOC_Node>
    {
        public S_DOC_NodeConfiguration()
        {
            ...
            Property(x => x.ExtentionJson).HasColumnName("EXTENTIONJSON").IsOptional().HasMaxLength(1073741823);
            Property(x => x.SortIndex).HasColumnName("SORTINDEX").IsOptional();
            Property(x => x.IsPhysicalBox).HasColumnName("ISPHYSICALBOX").IsOptional().HasMaxLength(50);
            Property(x => x.IsElectronicBox).HasColumnName("ISELECTRONICBOX").IsOptional().HasMaxLength(50);
            Property(x => x.CanDownload).HasColumnName("CANDOWNLOAD").IsOptional().HasMaxLength(50);
            Property(x => x.DownloadFlowKey).HasColumnName("DOWNLOADFLOWKEY").IsOptional().HasMaxLength(50);

            // Foreign keys
            HasRequired(a => a.S_DOC_Space).WithMany(b => b.S_DOC_Node).HasForeignKey(c => c.SpaceID); // FK_S_DOC_Node_S_DOC_Space
        }
    }
    ...
    internal partial class S_DOC_NodeStrcutConfiguration : EntityTypeConfiguration<S_DOC_NodeStrcut>
    {
        public S_DOC_NodeStrcutConfiguration()
        {
            ...
            // Foreign keys
            HasRequired(a => a.S_DOC_Space).WithMany(b => b.S_DOC_NodeStrcut).HasForeignKey(c => c.SpaceID); // FK_S_DOC_NodeStrcut_S_DOC_Space
        }
    }
    ...
    internal partial class S_DOC_ReorganizeConfigConfiguration : EntityTypeConfiguration<S_DOC_ReorganizeConfig>
    {
        public S_DOC_ReorganizeConfigConfiguration()
        {
            ...
            Property(x => x.PhysicalType).HasColumnName("PHYSICALTYPE").IsOptional().HasMaxLength(50);
            Property(x => x.PhysicalButtons).HasColumnName("PHYSICALBUTTONS").IsOptional().HasMaxLength(500);
            Property(x => x.PhysicalMainFormCode).HasColumnName("PHYSICALMAINFORMCODE").IsOptional().HasMaxLength(50);
            Property(x => x.PhysicalMainListCode).HasColumnName("PHYSICALMAINLISTCODE").IsOptional().HasMaxLength(50);
            Property(x => x.PhysicalVolumnListCode).HasColumnName("PHYSICALVOLUMNLISTCODE").IsOptional().HasMaxLength(50);
            Property(x => x.ElectronicMainFormCode).HasColumnName("ELECTRONICMAINFORMCODE").IsOptional().HasMaxLength(50);
    ...
    // S_DOC_ReorganizeConfig_FileFormRelation
    internal partial class S_DOC_ReorganizeConfig_FileFormRelationConfiguration : EntityTypeConfiguration<S_DOC_ReorganizeConfig_FileFormRelation>
    {
        public S_DOC_ReorganizeConfig_FileFormRelationConfiguration()
        {
            ToTable("S_DOC_REORGANIZECONFIG_FILEFORMRELATION");
            HasKey(x => x.ID);

            Property(x => x.ID).HasColumnName("ID").IsRequired().HasMaxLength(50);
            Property(x => x.ReorganizeConfigID).HasColumnName("REORGANIZECONFIGID").IsOptional().HasMaxLength(50);
            Property(x => x.FileID).HasColumnName("FILEID").IsOptional().HasMaxLength(50);
            Property(x => x.FormCode).HasColumnName("FORMCODE").IsOptional().HasMaxLength(50);

            // Foreign keys
            HasOptional(a => a.S_DOC_ReorganizeConfig).WithMany(b => b.S_DOC_ReorganizeConfig_FileFormRelation).HasForeignKey(c => c.ReorganizeConfigID); // FK_S_DOC_ReorganizeConfig_FileFormRelation_S_DOC_ReorganizeConfig
        }
    }

    // S_DOC_ReorganizeConfig_NodeFormRelation
    internal partial class S_DOC_ReorganizeConfig_NodeFormRelationConfiguration : EntityTypeConfiguration<S_DOC_ReorganizeConfig_NodeFormRelation>
    {
        public S_DOC_ReorganizeConfig_NodeFormRelationConfiguration()
        {
            ToTable("S_DOC_REORGANIZECONFIG_NODEFORMRELATION");
            HasKey(x => x.ID);
            ...
            // Foreign keys
            HasOptional(a => a.S_DOC_ReorganizeConfig).WithMany(b => b.S_DOC_ReorganizeConfig_NodeFormRelation).HasForeignKey(c => c.ReorganizeConfigID); // FK_S_DOC_ReorganizeConfig_NodeFormRelation_S_DOC_ReorganizeConfig
        }
    }
