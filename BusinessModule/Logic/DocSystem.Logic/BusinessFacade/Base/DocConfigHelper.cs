    ...
    public class DocConfigHelper
    {
        ...
        public static S_DOC_Space CreateConfigSpaceByID(string spaceID = "")
        {
            ...
            if (configSpace == null)
            {
                ...
                var space = entities.Set<S_DOC_Space>().Include("S_DOC_TreeConfig").Include("S_DOC_NodeStrcut")
                    .Include("S_DOC_Node").Include("S_DOC_Node.S_DOC_NodeAttr")
                    .Include("S_DOC_File").Include("S_DOC_File.S_DOC_FileAttr").Include("S_DOC_File.S_DOC_AtlasConfigDetail")
                    .Include("S_DOC_Node.S_DOC_FileNodeRelation").Include("S_DOC_File.S_DOC_FileNodeRelation")
                    .Include("S_DOC_ListConfig").Include("S_DOC_ListConfig.S_DOC_ListConfigDetail").Include("S_DOC_ListConfig.S_DOC_QueryParam")
                    .Include("S_DOC_ReorganizeConfig").Include("S_DOC_ReorganizeConfig.S_DOC_ReorganizeConfig_FileFormRelation")
