...
{
    public partial class S_EP_ProductionSubsidyApply : BaseEPModel
    {
        public S_EP_ProductionSubsidyApply()
        {

        }

        public S_EP_ProductionSubsidyApply(Dictionary<string, object> dic)
        {
            this.FillModel(dic);
        }
        ...
        void setChangeLoad(Dictionary<string, object> cbsDic)
        {
            ...
            subsidyInfo.SetValue("UseValue", this.ModelDic.GetValue("SubsidyValue"));
            ...
            subsidyInfo.SetValue("ApplyFormCode", "ProductionSubsidy");
