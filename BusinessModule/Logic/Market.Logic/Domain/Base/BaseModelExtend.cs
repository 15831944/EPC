...
namespace Market.Logic.Domain
{
    public static class BaseModelExtend
    {
        ...
        /// <returns></returns>
        public static SQLHelper GetMarketSqlHelper(this BaseModel model)
        {
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public static MarketEntities GetMarketContext(this BaseModel model) 
        {
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public static Dictionary<string, object> ToDic(this BaseModel model)
        {
        ...
        /// <param name="canReturnNull"></param>
        /// <returns></returns>
