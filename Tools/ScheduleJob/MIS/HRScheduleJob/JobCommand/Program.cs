...
namespace JobTestConsole
{
    class Program
    {
        ...
        {
            var practice_instance = new HRScheduleJob.PracticeQualificationWarningJob();
            practice_instance.Execute(new VirJobExecutionContext());
            var employee_instance = new HRScheduleJob.EmployeeContractWarningJob();
            employee_instance.Execute(new VirJobExecutionContext());
        }
    }
