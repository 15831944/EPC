...
namespace Common.WebAPIKit.Commlib
{
    public static class Des
    {
        ...
        private static readonly byte[] s_vector =Encoding.UTF8.GetBytes("Goodways");// { 0x12, 0x34, 0x56, 0x78, 0x90, 0xAB, 0xCD, 0xEF };
        ...
        public static string Encode(string encryptString, string encryptKey)
        {
            ...
            return Convert.ToBase64String(mStream.ToArray()); //HEX.BytesToHexString(mStream.ToArray());
        }
        ...
        public static string Decode(string decryptString, string decryptKey)
        {
            ...
            byte[] rgbIV = s_vector;
            byte[] inputByteArray = Convert.FromBase64String(decryptString);// HEX.HexStringToBytes(decryptString);
            DESCryptoServiceProvider dCSP = new DESCryptoServiceProvider();
            MemoryStream mStream = new MemoryStream();
