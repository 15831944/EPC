...
//     Connection String:      "Data Source=10.10.1.5;Initial Catalog=WXStandard_Workflow;User ID=sa;PWD=123.zxc;"
...
namespace PushLogic.Domain
{
    ...
    public partial class FlowContext : DbContext
    {
        ...
        static FlowContext()
        {
            Database.SetInitializer<FlowContext>(null);
        }
        ...
        public FlowContext(string connectionString) : base(connectionString)
        {
        }
	...
	[Description("流程委托表")]
    public partial class S_WF_DefDelegate
    {
		/// <summary>ID</summary>	
		[Description("ID")]
	...
	[Description("流程定义路由表")]
    public partial class S_WF_DefRouting
    {
		/// <summary>ID</summary>	
		[Description("ID")]
        public string ID { get{return _ID;} set{_ID = value??"";} } // ID (Primary key)
	...
	[Description("流程定义环节表")]
    public partial class S_WF_DefStep
    {
		/// <summary></summary>	
		[Description("")]
        public string ID { get{return _ID;} set{_ID = value??"";} } // ID (Primary key)
		...
		/// <summary>是否允许推送到手机端</summary>	
		[Description("是否允许推送到手机端")]
	...
	/// <summary></summary>	
	[Description("")]
    public partial class S_WF_DefSubForm
    {
		/// <summary></summary>	
		[Description("")]
        public string ID { get{return _ID;} set{_ID = value??"";} } // ID (Primary key)
	...
	[Description("流程变量表")]
    public partial class S_WF_InsVariable
    {
		/// <summary></summary>	
		[Description("")]
        public string ID { get{return _ID;} set{_ID = value??"";} } // ID (Primary key)
    ...
    internal partial class S_WF_DefRoutingConfiguration : EntityTypeConfiguration<S_WF_DefRouting>
    {
        public S_WF_DefRoutingConfiguration()
        {
            ...
            Property(x => x.UserIDsFromField).HasColumnName("USERIDSFROMFIELD").IsOptional().HasMaxLength(50);
    ...
    internal partial class S_WF_InsTaskConfiguration : EntityTypeConfiguration<S_WF_InsTask>
    {
        public S_WF_InsTaskConfiguration()
        {
            ...
            Property(x => x.TaskUserIDs).HasColumnName("TASKUSERIDS").IsOptional().HasMaxLength(2000);
            Property(x => x.TaskUserNames).HasColumnName("TASKUSERNAMES").IsOptional().HasMaxLength(2000);
            Property(x => x.TaskUserIDsGroup).HasColumnName("TASKUSERIDSGROUP").IsOptional().HasMaxLength(2000);
            Property(x => x.TaskRoleIDs).HasColumnName("TASKROLEIDS").IsOptional().HasMaxLength(500);
            Property(x => x.TaskOrgIDs).HasColumnName("TASKORGIDS").IsOptional().HasMaxLength(500);
