...
namespace PDFViewer
{
    public class FileStoreHelper
    {
        ...
        public static string SaveFile(byte[] fileBuffer, string fileName, string src = "", bool isForm = true)
        {
            var id = GetService().SaveFile(fileName, string.Empty, string.Empty, string.Empty, fileBuffer, fileBuffer.Length, src);
            return id;
        }
