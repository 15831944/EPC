...
namespace JobTestConsole
{
    class Program
    {
        ...
        {
            //JPushTask.HuaWeiPushNcMsg.sendPushMessage("ADpEdtDBE0fvZ6HB-AXKXxRNeSv4qDlTGLWfdNqyNat2a-vdlcCraqlK5urYEc7VPoktlr_WXYDk97m3Wy5AoEFxXVr5qfnMm_U0xJuCK8zXa70sIkyzTHPfUR7-JFUekQ", "22444444", "35555555555553");
            //return;
            var instance = new JPushTask.PushTask();
