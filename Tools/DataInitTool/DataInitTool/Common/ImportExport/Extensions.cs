...
namespace Common.Logic
{
    ...
    public static class Extensions
    {
        ...
        /// <returns></returns>
        public static IEnumerable<CellErrorInfo> Vaildate(this ExcelTableInfo table, Action<CellValidationArgs> CellValidation)
        {
                ...
                for (int i = 0; i < table.Rows.Count; i++)
                {
                    ...
                    foreach (var cell in row.Cells)
                    {
                        ...
                        var args = new CellValidationArgs
                        {
                            ...
                            isDate = cell.Structure.isDate,
                            isDecimal = cell.Structure.isDecimal,
                            FieldClass = cell.Structure.FieldClass,
                            FieldID = cell.Structure.FieldID,
