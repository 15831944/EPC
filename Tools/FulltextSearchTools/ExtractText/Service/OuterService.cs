...
public partial class OuterService : System.Web.Services.Protocols.SoapHttpClientProtocol {
    ...
    private System.Threading.SendOrPostCallback GetFileFolderNameOperationCompleted;
    ...
    /// <remarks/>
    public OuterService() {
        this.Url = "http://localhost:8040/FileStore/Services/OuterService.asmx";
    }
    ...
    /// <remarks/>
    public event GetFileFolderNameCompletedEventHandler GetFileFolderNameCompleted;
    ...
    /// <remarks/>
    public System.IAsyncResult BeginLocalizeFile(string fileName, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("LocalizeFile", new object[] {
                    fileName}, callback, asyncState);
    }
    
    /// <remarks/>
    public string EndLocalizeFile(System.IAsyncResult asyncResult) {
    ...
    /// <remarks/>
    [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/GetFileFolderName", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
    public string GetFileFolderName(string fileName) {
        object[] results = this.Invoke("GetFileFolderName", new object[] {
                    fileName});
        return ((string)(results[0]));
    }
    
    /// <remarks/>
    public System.IAsyncResult BeginGetFileFolderName(string fileName, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("GetFileFolderName", new object[] {
                    fileName}, callback, asyncState);
    }
    
    /// <remarks/>
    public string EndGetFileFolderName(System.IAsyncResult asyncResult) {
        object[] results = this.EndInvoke(asyncResult);
        return ((string)(results[0]));
    }
    
    /// <remarks/>
    public void GetFileFolderNameAsync(string fileName) {
        this.GetFileFolderNameAsync(fileName, null);
    }
    
    /// <remarks/>
    public void GetFileFolderNameAsync(string fileName, object userState) {
        if ((this.GetFileFolderNameOperationCompleted == null)) {
            this.GetFileFolderNameOperationCompleted = new System.Threading.SendOrPostCallback(this.OnGetFileFolderNameOperationCompleted);
        }
        this.InvokeAsync("GetFileFolderName", new object[] {
                    fileName}, this.GetFileFolderNameOperationCompleted, userState);
    }
    
    private void OnGetFileFolderNameOperationCompleted(object arg) {
        if ((this.GetFileFolderNameCompleted != null)) {
            System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
            this.GetFileFolderNameCompleted(this, new GetFileFolderNameCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
        }
    }
    ...
    /// <remarks/>
    public System.IAsyncResult BeginGetFileFullPath(string fileName, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("GetFileFullPath", new object[] {
                    fileName}, callback, asyncState);
    }
    
    /// <remarks/>
    public string EndGetFileFullPath(System.IAsyncResult asyncResult) {
        object[] results = this.EndInvoke(asyncResult);
        return ((string)(results[0]));
    }
    ...
    /// <remarks/>
    public System.IAsyncResult BeginCopyFile(string fileName, string relateId, string fileCode, string version, string src, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("CopyFile", new object[] {
                    fileName,
                    relateId,
                    fileCode,
                    version,
                    src}, callback, asyncState);
    }
    
    /// <remarks/>
    public string EndCopyFile(System.IAsyncResult asyncResult) {
        object[] results = this.EndInvoke(asyncResult);
        return ((string)(results[0]));
    }
    ...
    /// <remarks/>
    public System.IAsyncResult BeginDelFileByRelateId(string relateId, string delReason, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("DelFileByRelateId", new object[] {
                    relateId,
                    delReason}, callback, asyncState);
    }
    
    /// <remarks/>
    public bool EndDelFileByRelateId(System.IAsyncResult asyncResult) {
        object[] results = this.EndInvoke(asyncResult);
        return ((bool)(results[0]));
    }
    ...
    /// <remarks/>
    public System.IAsyncResult BeginOverwriteFile(string fileId, string relateId, string fileCode, string version, byte[] bytes, long fileSize, string src, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("OverwriteFile", new object[] {
                    fileId,
                    relateId,
                    fileCode,
                    version,
    ...
    /// <remarks/>
    public bool EndOverwriteFile(System.IAsyncResult asyncResult) {
        object[] results = this.EndInvoke(asyncResult);
        return ((bool)(results[0]));
    }
    ...
    /// <remarks/>
    public System.IAsyncResult BeginDelFiles(string fileIds, string delReason, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("DelFiles", new object[] {
                    fileIds,
                    delReason}, callback, asyncState);
    }
    
    /// <remarks/>
    public bool EndDelFiles(System.IAsyncResult asyncResult) {
        object[] results = this.EndInvoke(asyncResult);
        return ((bool)(results[0]));
    }
    ...
    /// <remarks/>
    public System.IAsyncResult BeginGetFileNamesByRelateId(string relateId, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("GetFileNamesByRelateId", new object[] {
                    relateId}, callback, asyncState);
    }
    
    /// <remarks/>
    public string EndGetFileNamesByRelateId(System.IAsyncResult asyncResult) {
        object[] results = this.EndInvoke(asyncResult);
        return ((string)(results[0]));
    }
    ...
    /// <remarks/>
    public System.IAsyncResult BeginSaveFile(string name, string relateId, string code, string version, byte[] bytes, long fileSize, string src, System.AsyncCallback callback, object asyncState) {
    ...
    /// <remarks/>
    public System.IAsyncResult BeginAppendFile(string fileId, byte[] bytes, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("AppendFile", new object[] {
                    fileId,
                    bytes}, callback, asyncState);
    }
    
    /// <remarks/>
    public string EndAppendFile(System.IAsyncResult asyncResult) {
        object[] results = this.EndInvoke(asyncResult);
        return ((string)(results[0]));
    }
    ...
    /// <remarks/>
    public System.IAsyncResult BeginGetFileSize(string fileId, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("GetFileSize", new object[] {
                    fileId}, callback, asyncState);
    }
    
    /// <remarks/>
    public int EndGetFileSize(System.IAsyncResult asyncResult) {
        object[] results = this.EndInvoke(asyncResult);
        return ((int)(results[0]));
    }
    ...
    /// <remarks/>
    public System.IAsyncResult BeginGetFileBytes(string fileId, int pos, int length, System.AsyncCallback callback, object asyncState) {
        return this.BeginInvoke("GetFileBytes", new object[] {
                    fileId,
                    pos,
    ...
    /// <remarks/>
    public byte[] EndGetFileBytes(System.IAsyncResult asyncResult) {
        object[] results = this.EndInvoke(asyncResult);
        return ((byte[])(results[0]));
    }
...
/// <remarks/>
[System.CodeDom.Compiler.GeneratedCodeAttribute("wsdl", "2.0.50727.3038")]
public delegate void GetFileFolderNameCompletedEventHandler(object sender, GetFileFolderNameCompletedEventArgs e);

/// <remarks/>
[System.CodeDom.Compiler.GeneratedCodeAttribute("wsdl", "2.0.50727.3038")]
[System.Diagnostics.DebuggerStepThroughAttribute()]
[System.ComponentModel.DesignerCategoryAttribute("code")]
public partial class GetFileFolderNameCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
    
    private object[] results;
    
    internal GetFileFolderNameCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
            base(exception, cancelled, userState) {
        this.results = results;
    }
