...
namespace DocSystem
{
    public class DocConfigController : MvcAdapter.BaseController
    {
        ...
        protected override DbContext entities
        {
            get
            {
                if (_entities == null)
                {
                    _entities = FormulaHelper.GetEntities<DocConfigEntities>();
                }
                return _entities;
            }
        }
        ...
        protected virtual SQLHelper SqlHelper
        {
            get
            {
                if (_sqlHelper == null)
                {
                    _sqlHelper = SQLHelper.CreateSqlHelper(ConnEnum.InfrasBaseConfig);
                }
                return _sqlHelper;
            }
        }
    ...
    public class DocConfigController<T> : MvcAdapter.BaseController<T> where T : class, new()
    {
        private DbContext _entities = null;
        ...
        protected virtual void BeforeDelete(S_DOC_NodeStrcut entity) { }
        ...
        protected virtual void AfterSave(T entity, Dictionary<string, object> row, bool isNew) { }
