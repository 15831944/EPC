...
namespace DocSystem
{
    public class DocConstController : MvcAdapter.BaseController
    {
        ...
        protected override DbContext entities
        {
            get
            {
                if (_entities == null)
                {
                    _entities = FormulaHelper.GetEntities<DocConstEntities>();
                }
                return _entities;
            }
        }
        ...
        protected virtual SQLHelper SqlHelper
        {
            get
            {
                if (_sqlHelper == null)
                {
                    _sqlHelper = SQLHelper.CreateSqlHelper(ConnEnum.DocConst);
                }
                return _sqlHelper;
            }
        }
    ...
    public class DocConstController<T> : MvcAdapter.BaseController<T> where T : class, new()
    {
        private DbContext _entities = null;
