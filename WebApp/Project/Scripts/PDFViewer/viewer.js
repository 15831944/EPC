...
'use strict';
function gID(oriID) {
    var fileID = (!oriID) ? getQueryString('FileID') : oriID;
    if (fileID.indexOf('_') >= 0)
        fileID = fileID.split('_')[0];
    return fileID;
}
var DEFAULT_URL = '/Project/PDFViewer/GetEmptyPDF';
if (gID())
    DEFAULT_URL = '/Project/PDFViewer/GetFile?FileID=' + gID();
...
PDFJS.imageResourcesPath = '/MvcConfig/Scripts/images/';
PDFJS.workerSrc = '/MvcConfig/Scripts/PDF/build/pdf.worker.js';
PDFJS.cMapUrl = '/MvcConfig/Scripts/PDF/web/cmaps/';
...
var PDFPageView = (function PDFPageViewClosure() {
    ...
    PDFPageView.prototype = {
        ...
        draw: function PDFPageView_draw() {
            ...
            if (typeof (onDrawCanvas) != "undefined")
                onDrawCanvas(canvasWrapper);
            if (this.annotationLayer) {
...
var TextLayerBuilder = (function TextLayerBuilderClosure() {
    ...
    TextLayerBuilder.prototype = {
        ...
        setTextContent: function TextLayerBuilder_setTextContent(textContent) {
            ...
            //}
            var signPositions = getSignPositions(this.viewport.width, this.viewport.height, this.viewport.scale / (4 / 3)
                , this.pageNumber, this.textLayerDiv);
            for (var j = 0; j < signPositions.length; j++) {
                appendSign(signPositions[j], this.pageNumber);
            }
            if (typeof (onLoadComplete) != "undefined")
                onLoadComplete(this.pageNumber);
...
var PDFViewerApplication = {
    ...
    load: function pdfViewLoad(pdfDocument, scale) {
        ...
        if (typeof ("addContextMenu") != "undefined")
            addContextMenu();
    ...
    parseQueryString: function pdfViewParseQueryString(query) {
        ...
        for (var i = 0, ii = parts.length; i < ii; ++i) {
            ...
            var value = param.length > 1 ? ((key == "fileid") ? gID(param[1]) : param[1]) : null;
